...
export const course = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      to: [{ type: "course" }],
      description:
        "Leave empty for top-level subjects (Quran, Jurisprudence, etc.)",
      group: "content",
    }),
    defineField({
      name: "order",
    ...
    defineField({
      name: "price",
      type: "string",
      placeholder: "e.g. PKR 2,000/month or Free",
      group: "content",
    }),
    defineField({
      name: "duration",
    ...
    defineField({
      name: "body",
      type: "array",
      title: "Additional Page Content (Rich Text)",
      of: [
        { type: "block" },
        {
          type: "image",
    ...
    defineField({
      ...
      type: "string",
      title: '"What You\'ll Achieve" — Heading',
      group: "sections",
    }),
    defineField({
      name: "outcomes",
    ...
    defineField({
      name: "whyUsHeading",
      type: "string",
      title: '"Why Learn with Us" — Heading',
      group: "sections",
    }),
    defineField({
      name: "whyUs",
      type: "array",
      title: '"Why Learn with Us" — Points',
      of: [
        {
          type: "object",
          fields: [
      ...
      of: [
        {
          ...
          fields: [
            defineField({
              name: "label",
              type: "string",
              title: "Table Label (e.g. National Students — PKR)",
            }),
            defineField({
              name: "rows",
              type: "array",
              ...
              of: [
                {
                  ...
                  preview: {
                    select: { title: "plan", subtitle: "monthlyTotal" },
                  },
                },
              ],
            }),
