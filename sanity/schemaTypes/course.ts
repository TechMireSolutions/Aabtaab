...
export const course = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'quranType', type: 'string', title: 'Quran Course Type', description: 'Only for Quran subject',
      options: {
        list: [
    ...
    defineField({ name: 'instructor', type: 'reference', to: [{ type: 'scholar' }] }),
