...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          validation:  (r) => r.required().warning('Alt text is required for accessibility and image SEO'),
        }),
      ],
    }),
    defineField({
        ...
        { type: 'block' },
        {
          ...
          fields:  [
            defineField({
              ...
              type:        'string',
              title:       'Alt text',
              validation:  (r) => r.required().warning('Alt text required for every image'),
            }),
          ],
        },
      ],
    ...
    defineField({
      ...
      title: 'FAQ Items',
      group: 'faqs',
      description: 'Each Q&A pair is rendered as FAQ structured data, boosting eligibility for Google AI Overviews and People Also Ask boxes.',
      of: [
        {
          type:  'object',
          name:  'faqItem',
