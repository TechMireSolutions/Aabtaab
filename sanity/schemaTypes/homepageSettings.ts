...
export const homepageSettings = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'aboutBody1', type: 'text', title: 'About — Body Paragraph 1', rows: 3, initialValue: 'Aabtaab was founded with a single purpose — to make authentic Shia Islamic education and religious services accessible to every Muslim, regardless of location or background.' }),
