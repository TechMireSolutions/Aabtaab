...
export const service = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "order",
      type: "number",
      title: "Display Order (among siblings)",
      group: "content",
    }),
    ...
    defineField({
      name: "isBookable",
      type: "boolean",
      title: "Can users request this service?",
      initialValue: false,
      group: "content",
    }),
    defineField({
    ...
    defineField({
      name: "heroSubtitle",
      type: "string",
      title: 'Hero — Bold Subtitle (e.g. "Your Sacred Duty, Simplified")',
      group: "sections",
    }),
    defineField({
      name: "heroBody",
    ...
    defineField({
      name: "whyUsHeading",
      type: "string",
      title: '"Why Use Our Platform" — Heading',
      group: "sections",
    }),
    defineField({
      name: "whyUsImage",
    ...
    defineField({
      name: "whyUs",
      type: "array",
      title: '"Why Use Our Platform" — Feature Points',
      of: [
        {
          type: "object",
          fields: [
    ...
    defineField({
      ...
      type: "string",
      title: '"Our Commitment" — Heading',
      group: "sections",
    }),
    defineField({
      name: "commitment",
      type: "array",
      title: '"Our Commitment" — Points',
      of: [
        {
          type: "object",
          fields: [
