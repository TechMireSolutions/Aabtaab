  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-8 py-12">
        ...
        {/* Title */}
        <h1 className="font-bold text-[30px] lg:text-[38px] text-slate-900 leading-[1.12] tracking-[-0.02em] mb-5">
          {post.title}
        </h1>

        {/* Meta */}
        <div className="flex items-center flex-wrap gap-4 text-[13px] text-gray-400 mb-10 pb-8 border-b border-gray-100">
          {post.author?.name && (
        ...
        {/* Featured image */}
        {post.mainImage && (
          <div className="relative w-full aspect-[16/8] rounded-2xl overflow-hidden mb-10 shadow-sm">
            <Image
