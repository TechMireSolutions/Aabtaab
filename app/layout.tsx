...
import { sanityFetch, fetchSiteSettings, type SiteSettings } from '@/sanity/lib/sanityFetch'
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = settings?.description || 'Shia Islamic knowledge, online courses, and community services for Muslims in the United States.'
  ...
  const ogImageUrl = settings?.logo
    ? urlFor(settings.logo).width(1200).height(630).fit('fill').bg('1a1a2e').url()
  ...
  return {
    ...
    description,
    keywords: [
      'Shia Islam', 'Islamic education', 'Shia Muslim', 'Quran for kids',
      'Islamic school USA', 'Shia parenting', 'online Islamic courses',
      'Muharram events', 'Shia community United States',
    ],
