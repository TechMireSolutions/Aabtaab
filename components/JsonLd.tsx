...
export function ArticleJsonLd({
  ...
  authorName, siteUrl, slug, siteName, faqItems,
}: ArticleSchemaProps) {
...
export function EventJsonLd({
  ...
  eventType, status, venueName, streetAddress, city,
  state, postalCode, country, onlineUrl,
  organizerName, organizerUrl, registrationUrl,
  isFree, price, siteUrl, slug,
}: EventSchemaProps) {
