...
export default function WhatsAppButton({ number }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="w-0 overflow-hidden whitespace-nowrap text-sm-plus font-semibold opacity-0 transition-all duration-200 group-hover:w-auto group-hover:opacity-100">
        WhatsApp
      </span>
    </a>
  );
