...
Next.js **16** · React **19** · Sanity **6** · Tailwind **v4** · TypeScript · PM2 port **3000**

Full reference: **`techstack.md`** (dependencies, SEO, production, env vars).
...
| `06-file-structure.mdc` | Always — where new files go |
