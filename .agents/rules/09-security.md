...
description: Security rules — HTTPS, environment variables, input validation, form protection, email security, and Cloudflare
---
...
* Use a central environment configuration module (e.g. `lib/env/` or direct verification on load).
